...
<header>
    ...
    <section style='padding: 150px; margin: 30px;'>
            <div class="card">
                <img src="responsive.png" alt="HTML, CSS, and Javascript for Web Developers" style="width:100%">
                <h1>Learn Responsive Design</h1>
                <p class="price" style='font-size: 20px;'>$19.99</p>
                <p style='font-size: 20px;'>This course takes you on a journey through the many facets of modern responsive web design. The first few modules will ease you in with a history of where responsive...</p>
