...
<header>
    ...
    <section style='padding: 150px; margin: 30px;'>
            <div class="card">
                <img src="web.png" alt="HTML, CSS, and Javascript for Web Developers" style="width:100%">
                <h1>HTML, CSS, and Javascript for Web Developers</h1>
                <p class="price" style='font-size: 20px;'>$19.99</p>
                <p style='font-size: 20px;'>In this course, we will learn the basic tools that every web page coder needs to know. We will start from the ground up by learning how to...</p>
